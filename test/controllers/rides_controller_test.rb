...
class RidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update ride" do
    patch ride_url(@ride), params: { ride: { destination: @ride.destination, no ofpeople: @ride.noofpeople, origin: @ride.origin, ridetype: @ride.ridetype, takeoff: @ride.takeoff } }
